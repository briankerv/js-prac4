...
console.log("Ordering your milktea ... ");

// Creating a promise
const milkteaPromise = () => {
...
if (order) {
    ...
    resolve("After 5 seconds, milktea delivered!");
    }, 5000);
    } else {
    
    setTimeout(() => { // setTimeout is used to simulate a delay
    reject("After 5 seconds, milktea not delivered!");
    },5000);
    }
    });
    };
    ...
    console.log("Waiting for your milktea ... ");
...
// Configure git in your project folder and push your code to your repository. Refer to play_demogit.js for the steps.